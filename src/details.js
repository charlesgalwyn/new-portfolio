...
export const details={
    ...
    projects:[

        {
            ...
            img:clearout,
            description:"I am currently building this Website as a part of Clearout"
        },

        {
            ...
            tech:["React","Chakra UI","Node JS","Mongo DB","Express JS"],
            img:quizzie,
            description:"This Application is created as a part of Cuvette Evaluation"
        },
    ...
    
        {
            ...
            tech:["React","Chakra UI","Node JS","Mongo DB","Express JS"],
            img:nykaa,
            description:"E-Commerce Web Application of Dresses,User can order products from Application"
        }
